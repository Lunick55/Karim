...
public class AndrickPlugin
{
    ...
    [DllImport("AndrickPlugin")]
    public static extern bool InitServer(string username, int port, int maxUserCount);

    [DllImport("AndrickPlugin")]
    public static extern bool InitClient(string username, string ipAddress, int port);

    [DllImport("AndrickPlugin")]
    public static extern bool StartConnectingToServer();

    [DllImport("AndrickPlugin")]
    public static extern bool DisconnectFromServer();

    [DllImport("AndrickPlugin")]
    public static extern bool ShutdownRakNet();
}
